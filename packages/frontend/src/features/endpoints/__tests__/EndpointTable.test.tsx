...
describe("EndpointTable", () => {
  it("renders endpoints table", () => {
    renderWithProviders(<EndpointTable endpoints={mockEndpoints} onToggle={vi.fn()} toggleIsPending={false} onDelete={vi.fn()} onClickRow={vi.fn()} />);
  ...
  it("calls onToggle when switch clicked", async () => {
    ...
    renderWithProviders(<EndpointTable endpoints={mockEndpoints} onToggle={onToggle} toggleIsPending={false} onDelete={vi.fn()} onClickRow={vi.fn()} />);
  ...
  it("shows empty state when no endpoints", () => {
    renderWithProviders(<EndpointTable endpoints={[]} onToggle={vi.fn()} toggleIsPending={false} onDelete={vi.fn()} onClickRow={vi.fn()} />);
  ...
  it("calls onClickRow when row clicked", async () => {
    ...
    renderWithProviders(<EndpointTable endpoints={mockEndpoints} onToggle={vi.fn()} toggleIsPending={false} onDelete={vi.fn()} onClickRow={onClickRow} />);
